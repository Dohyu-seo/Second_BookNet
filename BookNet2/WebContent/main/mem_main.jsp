...
<link rel="stylesheet" href="/BookNet/css/proj_fixed.css?after=1">
<link rel="stylesheet" href="/BookNet/css/modal.css?after">
<link rel="stylesheet" href="/BookNet/css/w3.css?after">
	...
	<div>
		...
		<div id="header-wrap">
			<div class="header">
     		...
     		<!-- 풋터부분 -->
      <footer>
     	<jsp:include page="/include/seoFooter.jsp"/>
      </footer>
	</div>
</body>
</html>